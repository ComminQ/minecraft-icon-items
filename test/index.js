...
const testItem = (test, item, name) => {
  ...
  test.notEqual(
    typeof item.id,
    "undefined",
    "items should have an id property"
  );
  test.notEqual(
    typeof item.type,
    "undefined",
  ...
  test.notEqual(
    typeof item.meta,
    "undefined",
    "items should have a meta property"
  );
  test.notEqual(
    typeof item.icon,
    "undefined",
    "items should have an icon property"
  );
  test.end();
};
...
tap.test(
  "should be able to get an item by name with case insensitivity",
  (t) => {
    testItem(t, minecraftItems.get("stoNe"), "Stone");
  }
);
...
tap.test("should be able to get Bukkit Stone", (t) => {
